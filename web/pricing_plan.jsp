                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                        <div class="pricing_box_wrapper2 ms_cover">
                            <div class="pricing_heading_wrapper ms_cover">
                                <h3>普通会员</h3>
                            </div>
                            <div class="ui_pricing_five_wrapper">
                                <h3>$10/ <br><span>月</span></h3>
                            </div>
                            <div class="pricing_five_list_wrapper ms_cover">
                                <ul>
                                    <li>每月可下载 - 50首歌</li>
                                    <li>每月可上传 - 50分钟</li>
                                    <li>会员时间 - 1个月</li>
                            ...
                            <div class="ui_pricing_five_btn_wrapper ms_cover">
                                <a href="#">现在购买</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="pricing_overview">
                            ...
                            <div class="ms_acc_ovrview_list">
                                <ul>
                                    <li>订阅方案 <span>- 普通会员</span></li>
                                    <li>已付金额 <span>- $30</span></li>
                                    <li>剩余时长 <span>- 15天</span></li>
                                    <li>剩余下载歌曲 <span>- 21首歌</span></li>
                                    <li>剩余上传时长 <span>- 45分钟</span></li>
                                </ul>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="login_form_wrapper">
                            ...
                            <div class="login_remember_box">
                                <label class="control control--checkbox">是我保持邓丽
                                    <input type="checkbox">
