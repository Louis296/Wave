...
<nav>
    <ul>
        ...
        <li>
            <a href="pages-table.jsp"><span class="icon">&#128196;</span> Pages</a>
            <ul class="submenu">
        ...
        <li>
            <a href="files.jsp"><span class="icon">&#127748;</span> Media <span class="pip">7</span></a>
            <ul class="submenu">
        ...
        <li class="section">
            ...
            <ul class="submenu">
                ...
                <li><a href="comments-timeline.jsp">View comments</a></li>
            </ul>
        </li>
        <li><a href="statistics.jsp"><span class="icon">&#128202;</span> Statistics</a></li>
        <li><a href="users.jsp"><span class="icon">&#128101;</span> Users <span class="pip">3</span></a></li>
        <li>
