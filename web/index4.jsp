        ...
        <div id='cssmenu'>
            ...
            <ul class="sidebb">
                <li class='has-sub'><a href='#'><i class="flaticon-home"></i>index</a>
                    <ul>
                        <li>
                            <a href="index.jsp"> <i class="flaticon-home"></i>index I</a>
                        </li>
                ...
                <li class='has-sub'><a href='#'><i class="flaticon-playlist-3"></i>browse music</a>
                    <ul>
                        ...
                        <li><a href="genres.jsp"><i class="flaticon-files-and-folders"></i>genres</a></li>
                        <li><a href="genres_single.jsp"><i class="flaticon-smartphone"></i>genres single</a></li>
                ...
                <li class='has-sub'><a href='#'><i class="flaticon-playlist"></i> music blog</a>
                    <ul>
                        <li><a href="blog_categories.jsp"><i class="flaticon-vinyl"></i>blog category I</a></li>
                        <li>
                ...
                <li><a href='contact_us.jsp'><i class="flaticon-internet"></i>contact us</a></li>
                <li><a href='pricing_plan.jsp'><i class="flaticon-bell"></i>pricing plan</a></li>
                    ...
                    <ul class="main_nav_ul">
                        ...
                        <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">browse <i
                            ...
                            <ul class="navi_2_dropdown">
                                ...
                                <li class="parent">
                                    <a href="genres.jsp"><i class="fas fa-caret-right"></i>new genres</a>
                                </li>
                                <li class="parent">
                        ...
                        <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">more <i
                            ...
                            <ul class="navi_2_dropdown">
                                <li class="parent">
                                    <a href="contact_us.jsp"><i class="fas fa-caret-right"></i>contact</a>
                                </li>
                                <li class="parent">
                                    <a href="pricing_plan.jsp"><i class="fas fa-caret-right"></i> pricing plan </a>
                                </li>
                                <li class="parent">
                                ...
                                <div class="treanding_slider_main_box ms_cover">
                                    ...
                                    <div class="ms_treanding_box_overlay">
                                        ...
                                        <ul class="tranding_more_option">
                                            ...
                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-share"></i></span>share</a>
                                            </li>
                                            <li><a href="#"><span class="opt_icon"><i
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="download_app_store ms_cover">
                        ...
                        <p>There are many variations of passages of Lorem Ipsum available, but passages of Lorem this is
                            wow.</p>
