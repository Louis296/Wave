...
<!--  ------------------------------------------------------------------------------------------ -->
            ...
            <div class="m24_navigation_wrapper">
                ...
                <div class="navi_searchbar_wrapper">
                    <a id="search" href=""><i class="flaticon-magnifying-glass" ></i></a>
                ...
                <script>
                    $(document).ready(function(){
                        ...
                        $("#search").click(function(){
                            ...
                            //得到input的值
                            var word = $("#justAnotherInputBox").val();

                            //设置href的值
                            $("#search").attr("href","${pageContext.request.contextPath}/song/searchsong?word="+word);
                        });
                    });
                </script>
<%--                <script>--%>
<%--                    $('#justAnotherInputBox').bind('keydown',function(event){--%>
<%--                        if(event.keyCode === "13") {--%>
<%--                            alert(1111);--%>
<%--                        }--%>
<%--                    });--%>
                ...
                <div class="m24_navi_langauage_box">      
				    <div class="theme-switch-wrapper">
						...
						<!--<div class="lang_list_wrapper d-none d-sm-none d-md-none d-lg-none d-xl-block">
							<a href="#" data-toggle="modal" data-target="#myModal">language <i class="fas fa-language"></i></a>
						</div>   -->
                </div>
            </div>
        </div>
...
<%--            <img src="images/headphone.png" class="img-responsive" alt="img">--%>
        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="content">
                                        ...
                                        <h1 data-animation="animated fadeInUp">聆听</h1>

                                        <h2 data-animation="animated fadeInUp">你的世界</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="content">
                                        ...
                                        <h1 data-animation="animated fadeInUp">Wave</h1>

                                        <h2 data-animation="animated fadeInUp">感受律动</h2>
                                        <p data-animation="animated fadeInUp">
                                            <br> </p>
                                        <div class="slider_btn ms_cover">
                                            <div class="lang_apply_btn">
                        ...
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                ...
                                <div class="treanding_slider_main_box ms_cover">
                                    <img src="images/ms1.jpg" alt="img">
...
<%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-trash"></i></span>删除</a></li>--%>
                            ...
                            <div class="item">
                                <div class="treanding_slider_main_box ms_cover">
                                    <img src="images/ms2.jpg" alt="img">
                                    <div class="ms_treanding_box_overlay">
                                        <div class="ms_tranding_box_overlay"></div>
                                        <div class="ms_tranding_more_icon">
                                            <i class="flaticon-menu"></i>
                            ...
                            <div class="item">
                                <div class="treanding_slider_main_box ms_cover">
                                    <img src="images/ms3.jpg" alt="img">
                                    <div class="ms_treanding_box_overlay">
                                        <div class="ms_tranding_box_overlay"></div>
                                        <div class="ms_tranding_more_icon">
                                            <i class="flaticon-menu"></i>
                            ...
                            <div class="item">
                                <div class="treanding_slider_main_box ms_cover">
                                    <img src="images/ms4.jpg" alt="img">
                                    <div class="ms_treanding_box_overlay">
                                        <div class="ms_tranding_box_overlay"></div>
                                        <div class="ms_tranding_more_icon">
                                            <i class="flaticon-menu"></i>
                                        ...
                                        <ul class="tranding_more_option">
                                            <li><a href="${pageContext.request.contextPath}/song/addtosonglist?songid=1004&index=true"><span class="opt_icon"><i class="flaticon-playlist"></i></span>添加至歌单</a></li>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-star"></i></span>喜欢</a></li>--%>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-share"></i></span>分享</a></li>--%>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-files-and-folders"></i></span>查看歌词</a></li>--%>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-trash"></i></span>删除</a></li>--%>
                                        ...
                                        <div class="tranding_play_icon">
                                            <a href="${pageContext.request.contextPath}/song/addtosonglist?songid=1004&index=true">
                                                <i class="flaticon-play-button"></i>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class="treanding_slider_main_box ms_cover">
                                    <img src="images/ms5.jpg" alt="img">
                                    <div class="ms_treanding_box_overlay">
                                        <div class="ms_tranding_box_overlay"></div>
                                        <div class="ms_tranding_more_icon">
                                            <i class="flaticon-menu"></i>
                                        ...
                                        <ul class="tranding_more_option">
                                            <li><a href="${pageContext.request.contextPath}/song/addtosonglist?songid=1005&index=true"><span class="opt_icon"><i class="flaticon-playlist"></i></span>添加至歌单</a></li>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-star"></i></span>喜欢</a></li>--%>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-share"></i></span>分享</a></li>--%>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-files-and-folders"></i></span>查看歌词</a></li>--%>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-trash"></i></span>删除</a></li>--%>
                                        ...
                                        <div class="tranding_play_icon">
                                            <a href="${pageContext.request.contextPath}/song/addtosonglist?songid=1005&index=true">
                                                <i class="flaticon-play-button"></i>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class="treanding_slider_main_box ms_cover">
                                    <img src="images/ms6.jpg" alt="img">
                                    <div class="ms_treanding_box_overlay">
                                        <div class="ms_tranding_box_overlay"></div>
                                        <div class="ms_tranding_more_icon">
                                            <i class="flaticon-menu"></i>
                                        ...
                                        <ul class="tranding_more_option">
                                            <li><a href="${pageContext.request.contextPath}/song/addtosonglist?songid=1006&index=true"><span class="opt_icon"><i class="flaticon-playlist"></i></span>添加至歌单</a></li>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-star"></i></span>喜欢</a></li>--%>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-share"></i></span>分享</a></li>--%>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-files-and-folders"></i></span>查看歌词</a></li>--%>
                                            <%--                                            <li><a href="#"><span class="opt_icon"><i class="flaticon-trash"></i></span>删除</a></li>--%>
                                        ...
                                        <div class="tranding_play_icon">
                                            <a href="${pageContext.request.contextPath}/song/addtosonglist?songid=1006&index=true">
                                                <i class="flaticon-play-button"></i>
                                            </a>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="add_banner_img_wrapper ms_cover">
                       <!-- <a href="#"><img src="images/add2.png" class="img-responsive" alt="img"></a>-->
                    </div>
                </div>
            </div>
        </div>
...
<%--    </div>--%>
    ...
    <div class="pricing_plan_wrapper ms_cover">
        <div class="container">
            <div class="row">

                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="pricing_box_wrapper ms_cover">
                        <h1>普通会员</h1>
                        <div class="main_pdet ms_cover">

                            <h2><span class="dollarr"> $ </span> 10 </h2> <span class="monthly">/ 月</span>
                        </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="pricing_box_wrapper ms_cover">
                        ...
                        <div class="main_pdet ms_cover">
                            ...
                            <h2><span class="dollarr"> $ </span> 20 </h2><span class="monthly"> / 月</span>
                        </div>
                        <ul class="pricing_list22">
                            <li>每月可下载 - 100首歌
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="pricing_box_wrapper ms_cover">
                        ...
                        <div class="main_pdet ms_cover">
                            ...
                            <h2><span class="dollarr"> $ </span> 30 </h2> <span class="monthly"> / 月</span>
                        </div>
                        <ul class="pricing_list22">
                            <li>每月可下载 - 500首歌
    ...
    <div class="add_banner_wrapper ms_cover">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="add_banner_img_wrapper ms_cover">
                        <!--<a href="#"><img src="images/add7.png" class="img-responsive" alt="img"></a>-->
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="add_banner_wrapper ms_cover">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="add_banner_img_wrapper ms_cover">
                       <!-- <a href="#"><img src="images/add1.png" class="img-responsive" alt="img"></a>-->
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="lr_prt_img_wrapper">
                                    <img src="images/prt1.png" alt="partner_img">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lr_prt_img_wrapper">
                                    <img src="images/prt2.png" alt="partner_img">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lr_prt_img_wrapper">
                                    <img src="images/prt3.png" alt="partner_img">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lr_prt_img_wrapper">
                                    <img src="images/prt4.png" alt="partner_img">
                                </div>
                            </div>
                            <div class="item">
                                <div class="lr_prt_img_wrapper">
                        ...
                        <div class="media current-item">
                            ...
                            <div class="des_option_wrapper">
                                ...
                                <ul class="tranding_more_option">
                                    ...
                                    <li><a href="#"><span class="opt_icon"><i class="flaticon-share"></i></span>分享</a></li>
                                    <li><a href="#"><span class="opt_icon"><i class="flaticon-files-and-folders"></i></span>查看歌词</a></li>
                                    <li><a id="delete" href=""><span class="opt_icon"><i class="flaticon-trash"></i></span>删除</a></li>
                                </ul>
                                <script>
                                    $(document).ready(function(){
                                        //点击链接的时候调用
                                        $("#delete").click(function(){
                                            ...
                                            //得到input的值
                                            var songaddress = $("#jp_audio_0").attr("src");

                                            //设置href的值
                                            $("#delete").attr("href","${pageContext.request.contextPath}/song/deletesongfromlist?songaddress="+songaddress);
                                        });
                                    });
                                </script>
                            </div>
